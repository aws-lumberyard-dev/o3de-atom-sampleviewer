...
namespace AtomSampleViewer
{
    ...
    void SponzaBenchmarkComponent::BenchmarkLoadEnd()
    {
        ...
        const AZStd::string unresolvedPath = AZStd::string::format("@user@/benchmarks/sponzaLoad_%" PRIu64 ".xml", time(0));
    ...
    void SponzaBenchmarkComponent::BenchmarkRunEnd()
    {
        ...
        const AZStd::string unresolvedPath = AZStd::string::format("@user@/benchmarks/sponzaRun_%" PRIu64 ".xml", time(0));
